	...
	if(isset($_POST["inregistare"])) {
		...
		if ($result->num_rows > 0) {
			while($row = $result->fetch_assoc()) {
				echo "Exista deja un cont pentru acest cnp. In cazul in care ai uitat parola, click <a href='util/resetareParola.php'>aici</a> pentru recuperarea parolei";
			}
		} else {
			...
			if($resultUser){
				header('Location: inregistrat.php');
			 }else {
